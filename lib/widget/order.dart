...
class Order extends StatelessWidget {
  ...
  Order(
    ...
    this.img = '',
       ...
       formattedDeliveryDate = DateFormat(
         'yyyy-MM-dd',
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Image.asset("images/de.gif", width: 40),
                                    ],
                                  ),
                                ),
                              ),
...
Future<void> _showDelayOrLateDialog(BuildContext context, String type) async {
  ...
  await showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: Text(
          isDelay ? 'Delay Order' : 'Late Order',
        ...
        content: Column(
          ...
          children: [
            RadioListTile<String>(
              title: Text(
                "The Customer's delivery location is too far from me",
                style: TextStyle(fontFamily: 'cairo'),
              ),
              value: "Reason 1",
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...delegators.map(
              (delegator) => RadioListTile<String>(
                title: Text(delegator, style: TextStyle(fontFamily: 'cairo')),
                value: delegator,
