  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Add New Delegators", style: TextStyle(fontFamily: "cairo")),
        leading: IconButton(
          onPressed: () {
            Navigator.pop(context); // Go back when the back icon is pressed
          },
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField(
                    ...
                    items: _citiesByRegion[_selectedRegion]
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.pop(context, newDelegator); // Return new delegator
                    },
