...
class _AssignedState extends State<Assigned> {
  ...
  void initState() {
    allOrders = [
      ...
      Order(313526, "yomna khaled", "At Evening", "Assigned", false,
          total: '100.00 SAR',
          ...
          img: 'Group3',
          isAgent: widget.isAgent),
      Order(313527, "alaa waled", "At Evening", "Assigned", true,
          total: '214.00 SAR',
          ...
          img: 'Group2',
          isAgent: widget.isAgent),
      Order(313528, "oday al-qasem", "At Evening", "Assigned", true,
          total: '716.50 SAR',
          clientNumber: '0599864230',
          addressType: 'home',
          paymentType: 'Cash',
          ...
          img: 'Group2',
          isAgent: widget.isAgent),
      Order(313530, "esraa waled", "At Evening", "Assigned", false,
          total: '222.00 SAR',
        ...
        child: Column(
          children: [
            ...
            if (!widget.isAgent) ...[
              Container(
                margin:
                    EdgeInsets.only(top: 10, right: 20, left: 20, bottom: 0),
                // Add margin only for non-first cards
                child: Order(
                  313525,
                  "suliman ali",
