    ...
    if (_mobileNumFormKey.currentState?.validate() == true &&
      ...
      switch (selectedIndex) {
        case 0:
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (context) => Home(isAgent: true)));
          break;
        case 1:
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (context) => Home(isAgent: false)));
          break;
        case 2:
          Navigator.of(
            context,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisAlignment:
              MainAxisAlignment.spaceBetween, // Use this property
          children: [
